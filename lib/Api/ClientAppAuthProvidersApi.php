...
class ClientAppAuthProvidersApi
{
     ...
     */
    public function createFirebaseAuthProvider($client_app_uid, $uid, $create_firebase_auth_provider_request)
    {
        list($response) = $this->createFirebaseAuthProviderWithHttpInfo($client_app_uid, $uid, $create_firebase_auth_provider_request);
        return $response;
    }
     ...
     */
    public function createFirebaseAuthProviderWithHttpInfo($client_app_uid, $uid, $create_firebase_auth_provider_request)
    {
        $request = $this->createFirebaseAuthProviderRequest($client_app_uid, $uid, $create_firebase_auth_provider_request);
     ...
     */
    public function createFirebaseAuthProviderAsync($client_app_uid, $uid, $create_firebase_auth_provider_request)
    {
        return $this->createFirebaseAuthProviderAsyncWithHttpInfo($client_app_uid, $uid, $create_firebase_auth_provider_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFirebaseAuthProviderAsyncWithHttpInfo($client_app_uid, $uid, $create_firebase_auth_provider_request)
    {
        $returnType = '\Jalismrs\Stalactite\Client\Auth\Model\FirebaseAuthProvider';
        $request = $this->createFirebaseAuthProviderRequest($client_app_uid, $uid, $create_firebase_auth_provider_request);
     ...
     */
    public function createFirebaseAuthProviderRequest($client_app_uid, $uid, $create_firebase_auth_provider_request)
    {
     ...
     */
    public function createGoogleAuthProvider($client_app_uid, $uid, $create_google_auth_provider_request)
    {
        list($response) = $this->createGoogleAuthProviderWithHttpInfo($client_app_uid, $uid, $create_google_auth_provider_request);
        return $response;
    }
     ...
     */
    public function createGoogleAuthProviderWithHttpInfo($client_app_uid, $uid, $create_google_auth_provider_request)
    {
        $request = $this->createGoogleAuthProviderRequest($client_app_uid, $uid, $create_google_auth_provider_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGoogleAuthProviderAsync($client_app_uid, $uid, $create_google_auth_provider_request)
    {
        return $this->createGoogleAuthProviderAsyncWithHttpInfo($client_app_uid, $uid, $create_google_auth_provider_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGoogleAuthProviderAsyncWithHttpInfo($client_app_uid, $uid, $create_google_auth_provider_request)
    {
        $returnType = '\Jalismrs\Stalactite\Client\Auth\Model\GoogleAuthProvider';
        $request = $this->createGoogleAuthProviderRequest($client_app_uid, $uid, $create_google_auth_provider_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createGoogleAuthProviderRequest($client_app_uid, $uid, $create_google_auth_provider_request)
    {
        // verify the required parameter 'client_app_uid' is set
        if ($client_app_uid === null || (is_array($client_app_uid) && count($client_app_uid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getAllClientAppAuthProviders($client_app_uid, $uid)
    {
        list($response) = $this->getAllClientAppAuthProvidersWithHttpInfo($client_app_uid, $uid);
        return $response;
    }
     ...
     */
    public function getAllClientAppAuthProvidersWithHttpInfo($client_app_uid, $uid)
    {
        $request = $this->getAllClientAppAuthProvidersRequest($client_app_uid, $uid);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllClientAppAuthProvidersAsync($client_app_uid, $uid)
    {
        return $this->getAllClientAppAuthProvidersAsyncWithHttpInfo($client_app_uid, $uid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllClientAppAuthProvidersAsyncWithHttpInfo($client_app_uid, $uid)
    {
        $returnType = '\Jalismrs\Stalactite\Client\Auth\Model\GetClientAppAuthProvidersResponse';
        $request = $this->getAllClientAppAuthProvidersRequest($client_app_uid, $uid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllClientAppAuthProvidersRequest($client_app_uid, $uid)
    {
        // verify the required parameter 'client_app_uid' is set
        if ($client_app_uid === null || (is_array($client_app_uid) && count($client_app_uid) === 0)) {
            throw new \InvalidArgumentException(
