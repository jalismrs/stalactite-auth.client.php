...
class AuthProvidersApi
{
    ...
    /**
     * Operation deleteFirebaseAuthProvider
     *
     * @param  string $uid The uid of the Firebase auth provider to delete (required)
     *
     * @throws \Jalismrs\Stalactite\Client\Auth\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteFirebaseAuthProvider($uid)
    {
        $this->deleteFirebaseAuthProviderWithHttpInfo($uid);
    }

    /**
     * Operation deleteFirebaseAuthProviderWithHttpInfo
     *
     * @param  string $uid The uid of the Firebase auth provider to delete (required)
     *
     * @throws \Jalismrs\Stalactite\Client\Auth\ApiException on non-2xx response
     ...
     */
    public function deleteFirebaseAuthProviderWithHttpInfo($uid)
    {
        $request = $this->deleteFirebaseAuthProviderRequest($uid);
    ...
    /**
     * Operation deleteFirebaseAuthProviderAsync
     *
     * @param  string $uid The uid of the Firebase auth provider to delete (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function deleteFirebaseAuthProviderAsync($uid)
    {
        return $this->deleteFirebaseAuthProviderAsyncWithHttpInfo($uid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteFirebaseAuthProviderAsyncWithHttpInfo
     *
     * @param  string $uid The uid of the Firebase auth provider to delete (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteFirebaseAuthProviderAsyncWithHttpInfo($uid)
    {
        $returnType = '';
        $request = $this->deleteFirebaseAuthProviderRequest($uid);
    ...
    /**
     * Create request for operation 'deleteFirebaseAuthProvider'
     *
     * @param  string $uid The uid of the Firebase auth provider to delete (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function deleteFirebaseAuthProviderRequest($uid)
    {
        // verify the required parameter 'uid' is set
        if ($uid === null || (is_array($uid) && count($uid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $uid when calling deleteFirebaseAuthProvider'
            );
        }
        if (!preg_match("/[a-z0-9]{64}/", $uid)) {
            throw new \InvalidArgumentException("invalid value for \"uid\" when calling AuthProvidersApi.deleteFirebaseAuthProvider, must conform to the pattern /[a-z0-9]{64}/.");
        }
    ...
    /**
     * Operation deleteGoogleAuthProvider
     *
     * @param  string $uid The uid of the Google auth provider to delete (required)
     *
     * @throws \Jalismrs\Stalactite\Client\Auth\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteGoogleAuthProvider($uid)
    {
        $this->deleteGoogleAuthProviderWithHttpInfo($uid);
    }

    /**
     * Operation deleteGoogleAuthProviderWithHttpInfo
     *
     * @param  string $uid The uid of the Google auth provider to delete (required)
     *
     * @throws \Jalismrs\Stalactite\Client\Auth\ApiException on non-2xx response
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteGoogleAuthProviderWithHttpInfo($uid)
    {
        $request = $this->deleteGoogleAuthProviderRequest($uid);
    ...
    /**
     * Operation deleteGoogleAuthProviderAsync
     *
     * @param  string $uid The uid of the Google auth provider to delete (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteGoogleAuthProviderAsync($uid)
    {
        return $this->deleteGoogleAuthProviderAsyncWithHttpInfo($uid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteGoogleAuthProviderAsyncWithHttpInfo
     *
     * @param  string $uid The uid of the Google auth provider to delete (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteGoogleAuthProviderAsyncWithHttpInfo($uid)
    {
        $returnType = '';
        $request = $this->deleteGoogleAuthProviderRequest($uid);
    ...
    /**
     * Create request for operation 'deleteGoogleAuthProvider'
     *
     * @param  string $uid The uid of the Google auth provider to delete (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteGoogleAuthProviderRequest($uid)
    {
        // verify the required parameter 'uid' is set
        if ($uid === null || (is_array($uid) && count($uid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $uid when calling deleteGoogleAuthProvider'
            );
        }
        if (!preg_match("/[a-z0-9]{64}/", $uid)) {
            throw new \InvalidArgumentException("invalid value for \"uid\" when calling AuthProvidersApi.deleteGoogleAuthProvider, must conform to the pattern /[a-z0-9]{64}/.");
        }
    ...
    public function getFirebaseAuthproviderRequest($uid)
    {
        ...
        if (!preg_match("/[a-z0-9]{64}/", $uid)) {
            throw new \InvalidArgumentException("invalid value for \"uid\" when calling AuthProvidersApi.getFirebaseAuthprovider, must conform to the pattern /[a-z0-9]{64}/.");
        }
    ...
    public function getGoogleAuthproviderRequest($uid)
    {
        ...
        if (!preg_match("/[a-z0-9]{64}/", $uid)) {
            throw new \InvalidArgumentException("invalid value for \"uid\" when calling AuthProvidersApi.getGoogleAuthprovider, must conform to the pattern /[a-z0-9]{64}/.");
        }
