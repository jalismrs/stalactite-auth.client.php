...
class FirebaseAuthProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['project_id']) < 0)) {
    ...
    public function setUid($uid)
    {
        ...
        if ((!preg_match("/[a-z0-9]{64}/", $uid))) {
            throw new \InvalidArgumentException("invalid value for $uid when calling FirebaseAuthProvider., must conform to the pattern /[a-z0-9]{64}/.");
        }
    ...
    public function setProjectId($project_id)
    {
        ...
        if ((mb_strlen($project_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $project_id when calling FirebaseAuthProvider., must be bigger than or equal to 0.');
        }
