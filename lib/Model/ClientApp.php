...
class ClientApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ClientApp., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ClientApp., must be bigger than or equal to 0.');
        }
    ...
    public function setUid($uid)
    {
        ...
        if ((!preg_match("/[a-z0-9]{64}/", $uid))) {
            throw new \InvalidArgumentException("invalid value for $uid when calling ClientApp., must conform to the pattern /[a-z0-9]{64}/.");
        }
